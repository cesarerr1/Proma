...
class UntitledTestCase(unittest.TestCase):
    ...
    def test_untitled_test_case(self):
        ...
        driver.find_element_by_xpath(
            "/html/body/app-my-app/app-home-operador/div/div[2]/div[3]/app-crear-evento/div/form/div[4]/div[2]/div/div/button[5]/span/mat-icon").click()
        time.sleep(3)
        ...
        driver.get(
            "http://promad.opensystems.mx:8081/common/datos-complementarios/dinero/involucrado/form/ABANDONO-ORGANOS%20-%20TEJIDO-EXTREMIDADES/C5*20200706*31/155/null")
        time.sleep(3)
        ...
        time.sleep(1)
        driver.find_element_by_id("mat-input-1").send_keys("automatización dinero involucrado")
        time.sleep(1)

        time.sleep(1)
        driver.find_element_by_xpath(
            "/html/body/app-my-app/app-dinero-involucrado/div/app-dinero-involucrado-form/form/div[3]/div/button[2]/span").click()
        time.sleep(1)
